...
RegisterCommand( _make_check( 1,  "Check AlwaysInstallElevated" ),                "privkit", "aie",       "Check AlwaysInstallElevated",                0, "", "" )
RegisterCommand( _make_check( 2,  "Check Unquoted Service Paths" ),               "privkit", "usp",       "Check Unquoted Service Paths",               0, "", "" )
RegisterCommand( _make_check( 3,  "Check Modifiable Services (weak DACL)" ),      "privkit", "modsvc",    "Check Modifiable Services (weak DACL)",      0, "", "" )
...
RegisterCommand( _make_check( 6,  "Check Writable PATH Directories" ),            "privkit", "wpath",     "Check Writable PATH Directories",            0, "", "" )
RegisterCommand( _make_check( 7,  "Check UAC Settings" ),                         "privkit", "uac",       "Check UAC Settings",                         0, "", "" )
RegisterCommand( _make_check( 8,  "Check Token Privileges" ),                     "privkit", "privs",     "Check Token Privileges",                     0, "", "" )
