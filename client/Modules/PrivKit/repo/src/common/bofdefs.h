...
WINBASEAPI WINBOOL WINAPI KERNEL32$DeleteFileA(LPCSTR);
WINBASEAPI DWORD WINAPI KERNEL32$GetFileAttributesA(LPCSTR);
WINBASEAPI char* WINAPI KERNEL32$lstrcpyA(char*, const char*);
WINBASEAPI char* WINAPI KERNEL32$lstrcatA(char*, const char*);
WINBASEAPI DWORD WINAPI KERNEL32$GetEnvironmentVariableA(LPCSTR, LPSTR, DWORD);
WINBASEAPI WINBOOL WINAPI KERNEL32$GetFileSizeEx(HANDLE, PLARGE_INTEGER);
...
WINADVAPI WINBOOL WINAPI ADVAPI32$CredEnumerateA(LPCSTR, DWORD, DWORD*, PCREDENTIALA**);
WINADVAPI LONG WINAPI ADVAPI32$RegGetValueA(HKEY, LPCSTR, LPCSTR, DWORD, LPDWORD, PVOID, LPDWORD);
...
WINADVAPI WINBOOL WINAPI ADVAPI32$QueryServiceObjectSecurity(SC_HANDLE, SECURITY_INFORMATION, PSECURITY_DESCRIPTOR, DWORD, LPDWORD);
WINADVAPI WINBOOL WINAPI ADVAPI32$IsValidSid(PSID pSid);
...
#define KERNEL32$lstrcpyA lstrcpyA
#define KERNEL32$lstrcatA lstrcatA
#define KERNEL32$GetEnvironmentVariableA GetEnvironmentVariableA
...
#define ADVAPI32$CredEnumerateA CredEnumerateA
#define ADVAPI32$RegGetValueA RegGetValueA
...
#define ADVAPI32$QueryServiceObjectSecurity QueryServiceObjectSecurity
#define ADVAPI32$IsValidSid IsValidSid
