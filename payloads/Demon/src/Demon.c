...
VOID DemonMetaData( PPACKAGE* MetaData, BOOL Header )
{
    ...
    */
    ...
    Instance->Win32.RtlGetVersion( (PRTL_OSVERSIONINFOW)&OsVersions );  // Cast OSVERSIONINFOEXW to base type
...
VOID DemonInit( PVOID ModuleInst, PKAYN_ARGS KArgs )
{
    ...
    if ( NT_SUCCESS( Instance->Win32.RtlGetVersion( (PRTL_OSVERSIONINFOW)&OSVersionExW ) ) ) {  // Cast to base type
